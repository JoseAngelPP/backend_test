...
AWS_QUEUE_NAME_MS = os.getenv("AWS_QUEUE_NAME_MS")
AWS_DEAD_LETTER_QUEUE_NAME_MS = os.getenv("AWS_DEAD_LETTER_QUEUE_NAME_MS")
AWS_QUEUE_GROUP_ID_MS = os.getenv("AWS_QUEUE_GROUP_ID_MS")
